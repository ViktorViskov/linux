...
# print result
echo "<txt><span weight=\"bold\" fgcolor=\"Green\">CPU $CPU_Temp</span><span weight=\"bold\" fgcolor=\"Orange\"> $CPU_Freq_Current</span><span weight=\"bold\" fgcolor=\"Red\"> $CPU_Freq_Max </span>$CPU_Turbo<span weight=\"bold\" fgcolor=\"Cyan\"> RAM $RAM </span>$Battery_Safe</txt>"
